        ...
        <div class="container px-6 py-12 mx-auto">
            ...
            <div class="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
                <div class="flex flex-col items-center justify-center text-center">
                    <span class="p-3 text-purple-400 rounded-full bg-gray-300/80 ">
                    ...
                    <p class="mt-2 text-purple-400 ">hello@merakiui.com</p>
                </div>
                ...
                <div class="flex flex-col items-center justify-center text-center">
                    ...
                    <p class="mt-2 text-purple-400 ">100 Smith Street Collingwood VIC 3066 AU</p>
                </div>
                ...
                <div class="flex flex-col items-center justify-center text-center">
                    ...
                    <p class="mt-2 text-purple-400 ">+1 (555) 000-0000</p>
                </div>
            </div>
        </div>
    </section>
